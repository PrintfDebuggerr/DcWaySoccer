// Upload footer assets (white DC Way logo) from wordpress-reference/ to Shopify Files.
//
// Run: node scripts/admin-upload-footer-assets.mjs
...
const uploads = [
  {
    key: 'footer_logo',
    file: join(REF, 'Logo-white.png'),
    alias: 'dcway-logo-white.png',
    mime: 'image/png',
    alt: 'DC Way Soccer logo (white)',
  },
];
...
console.log('\nReference path in JSON: shopify://shop_images/dcway-logo-white.png');
