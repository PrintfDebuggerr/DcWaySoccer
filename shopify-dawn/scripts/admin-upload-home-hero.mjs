// Upload home-hero background image from wordpress-reference/ to Shopify Files.
//
// Run: node scripts/admin-upload-home-hero.mjs
...
const uploads = [
  {
    key: 'home_hero',
    file: join(REF, 'summer-camp-07-2023-0025-copy-7-2-scaled.jpg'),
    alias: 'dcway-home-hero.jpg',
    mime: 'image/jpeg',
    alt: 'DC Way Soccer summer camp group photo',
  },
];
...
console.log('\nReference path in JSON: shopify://shop_images/dcway-home-hero.jpg');
